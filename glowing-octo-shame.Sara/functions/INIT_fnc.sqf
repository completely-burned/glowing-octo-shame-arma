...
draga_fnc_isFlatEmpty = compile (preprocessFileLineNumbers (_path + "draga_fnc_isFlatEmpty.sqf"));
BIS_fnc_relPos = compile (preprocessFileLineNumbers (_path + "fn_relPos.sqf"));
BIS_fnc_dirTo = compile (preprocessFileLineNumbers (_path + "fn_dirTo.sqf"));
BIS_FNC_createmenu = compile (preprocessFileLineNumbers (_path + "FN_createmenu.sqf"));
BIS_fnc_setNestedElement = compile (preprocessFileLineNumbers (_path + "fn_setNestedElement.sqf"));
BIS_fnc_selectRandom = compile (preprocessFileLineNumbers (_path + "fn_selectRandom.sqf"));
BIS_fnc_selectRandomWeighted = compile (preprocessFileLineNumbers (_path + "fn_selectRandomWeighted.sqf"));
BIS_fnc_returnConfigEntry = compile (preprocessFileLineNumbers (_path + "fn_returnConfigEntry.sqf"));
//BIS_fnc_isPosBlacklisted = compile (preprocessFileLineNumbers (_path + "fn_isPosBlacklisted.sqf"));
//BIS_fnc_inTrigger = compile (preprocessFileLineNumbers (_path + "fn_intrigger.sqf"));
BIS_fnc_arrayPush = compile (preprocessFileLineNumbers (_path + "fn_arrayPush.sqf"));
draga_fnc_group_init = compile (preprocessFileLineNumbers (_path + "draga_fnc_group_init.sqf"));
m_fnc_init = true;
